...
namespace Proxies\__CG__\MessagerieBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Message extends \MessagerieBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MessagerieBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'MessagerieBundle\\Entity\\Message' . "\0" . 'idDestinataire', '' . "\0" . 'MessagerieBundle\\Entity\\Message' . "\0" . 'idAuteur', '' . "\0" . 'MessagerieBundle\\Entity\\Message' . "\0" . 'sujet', '' . "\0" . 'MessagerieBundle\\Entity\\Message' . "\0" . 'corps'];
        }
    ...
    public function setIdAuteur($idAuteur)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdAuteur', [$idAuteur]);
